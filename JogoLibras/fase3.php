        ...
        <div id="geral">
            ...
            <div id="login">
              ...
              <br><br><br><br><br>
                ...
                <form id="formu" method="POST" action="Post/Fase3.php">
                    <fieldset style="border: none">  
                        <div id="user_div" >
                            ...
                            <br>
                                ...
                                <p>
                                  Conhece       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="radio" name="feliz" value="1"> 1 
                                              <input type="radio" name="feliz" value="2"> 2 
                                               <input type="radio" name="feliz" value="3"> 3 
                                  
                                </p>
                                <p>
                                      São Paulo     &nbsp&nbsp&nbsp &nbsp&nbsp  <input type="radio" name="surdo" value="1"> 1 
                                                    <input type="radio" name="surdo" value="2"> 2 
                                                     <input type="radio" name="surdo" value="3"> 3 
                                </p>
                                
                                <p>
                                      Você      &nbsp  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="radio" name="dia" value="1"> 1 
